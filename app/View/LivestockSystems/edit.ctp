...
<div>
    <?php echo $this->Form->create("LivestockSystem", array("id" => "formulario", 'url' => array('controller' => 'LivestockSystems', "action" => "edit", $this->data['LivestockSystem']['id']))); ?>
    ...
    <?php echo $this->Form->hidden('LivestockSystem.id'); ?>
    <?php echo $this->Form->hidden('LivestockSystem.productive_baseline_id'); ?>
