...
<div id="certification">
    <fieldset><legend>5.15 ¿Tiene algún tipo de registro o certificación en sus cultivos o productos?</legend>
        <?php echo $this->Form->create("Certification", array("id" => "formulario", "action" => "edit/" . $this->data['Certification']['productive_poll_id'])); ?>
        ...
        <?php echo $this->Form->hidden('Certification.productive_poll_id', array('label' => '', 'class' => '')); ?>
