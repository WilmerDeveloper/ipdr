...
<?php echo $this->Form->create("GenderInstitutionalSupport", array('id' => 'formulario', "action" => "add/" . $poll_id)); ?>
<?php echo $this->Form->hidden('GenderInstitutionalSupport.family_poll_id', array('value' => $poll_id)); ?>
<fieldset>
