...
<fieldset >
    <?php echo $this->Form->create("TitleStudy", array('id' => 'formulario', "action" => "add/" . $property_id)); ?>
    <legend>Edición de Estudio de título</legend>
    <?php echo $this->Form->hidden('TitleStudy.property_id', array('value' => $property_id, 'type' => 'text')); ?>
