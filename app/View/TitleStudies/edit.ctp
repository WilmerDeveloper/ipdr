...
<fieldset>
    ...
    <?php echo $this->Form->input('TitleStudy.quien_expide_titulo', array('label' => 'Quien expide el título')); ?>
    <?php echo $this->Form->input('TitleStudy.aplica_excepcion', array('label' => '¿Aplica excepción para el artículo 9A del acuerdo 308?', 'empty' => '', 'options' => array('Si' => 'Si', 'No' => 'No'))); ?>
    <?php
    echo $this->Form->input('TitleStudy.excepcion', array('label' => 'Excepción', 'empty' => '', 'options' => array(
            'a' => 'A Estar inscrito en el Sistema de Identificación de Potenciales Benefici...',
            'b' => 'B Ser propietario de un predio rural sin limitaciones de dominio jurídic...',
            'c' => 'C En caso de encontrarse en condición de desplazamiento, estar inscrito ...',
            'd' => 'D No ser requerido por las autoridades para el cumplimiento de pena priv...',
            'e' => 'E Contar con una actividad productiva en curso o tener intención de adel...',
            'f' => 'F En caso de que el beneficiario integre grupos étnicos, debe ser miembr...',
            'g' => 'G Declarar bajo la gravedad de juramento que no posee un patrimonio supe...'
            )));
    ?>
    <legend>Concepto y calificación final</legend>
    <?php echo $this->Form->input('TitleStudy.concepto_final', array('label' => 'Concepto final')); ?>
    <?php echo $this->Form->input('TitleStudy.calificacion', array('label' => 'calificación final', 'empty' => '', 'options' => array('Cumple' => 'Cumple', 'No cumple' => 'No cumple', 'Suspendido' => 'Suspendido'))); ?>
