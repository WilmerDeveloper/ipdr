...
<div>
    <?php echo $this->Form->create("Expense", array("id" => "ideF", 'url' => array('controller' => 'expenses', "action" => "edit", $this->data['Expense']['id']))); ?>
    <?php echo $this->Form->input('Expense.id', array('label' => 'id', 'class' => '')); ?>
    ...
    <div style= "border: solid 1px; border-color: #0063DC"><b>¿Ha tenido condición de vulnerabilidad?</b>
        <fieldset>
            ...
            <?php echo $this->Form->hidden('Expense.family_poll_id'); ?>
        </fieldset>
    </div>
