...
<fieldset>
    <?php echo $this->Form->create("ForestPoll", array("id" => "forest", 'url' => array("action" => "edit", $this->data['ForestPoll']['id']))); ?>
    ...
    <?php echo $this->Form->hidden('ForestPoll.plot_poll_id', array('label' => 'plot_poll_id')); ?>
    <?php echo $this->Form->hidden('ForestPoll.id', array('label' => 'plot_poll_id')); ?>
