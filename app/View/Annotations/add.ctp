...
<fieldset >
    <?php echo $this->Form->create("Annotation", array('id' => 'formulario', "action" => "add/" . $title_study_id. "/" . $property_id)); ?>
    <legend>Edición de Estudio de título</legend>
    <?php echo $this->Form->hidden('Annotation.title_study_id', array('value' => $title_study_id, 'type' => 'text')); ?>

    <?php
    echo $this->Form->input('Annotation.tipo_principal', array('label' => 'Tipo anotación', 'empty' => '', 'id' => 'tipo',
        'options' => array(
            'Falsa tradición' => 'Falsa tradición',
            'Gravamen' => 'Gravamen',
            'Limitación al derecho de dominio' => 'Limitación al derecho de dominio',
            'Medida cautelar' => 'Medida cautelar',
            'Título de tenencia' => 'Título de tenencia',
    ...
    <div id="gravamen">
        ...
        echo $this->Form->input('Annotation.tipo_secundario2', array('label' => 'Tipo gravamen', 'empty' => '',
            'options' => array(
                ...
                '213' => '0213.-  HIPOTECA NUDA PROPIEDAD. (Creado Res. 2708/2001)',
    ...
    <?php echo $this->Form->input('Annotation.observacion', array('label' => 'Observación')); ?>
