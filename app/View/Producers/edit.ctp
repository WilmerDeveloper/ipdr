...
<div id="productores">
    <fieldset>
        <?php echo $this->Form->create("Producer", array("id" => "producerEdit", 'url' => array("action" => "edit", $this->data['Producer']['id']))); ?>
        <?php echo $this->Form->hidden('Producer.id', array('label' => 'id',)); ?>
        ...
        <?php echo $this->Form->input('Producer.fecha_adjudicacion', array('label' => '2.13 Fecha de expedición de la Resolución:', 'class' => 'calendario', 'type' => 'text')); ?>
        ...
        <br><div>
            <fieldset>2.10Topografía:
                ...
                <?php echo $this->Form->hidden('Producer.property_id', array()); ?>
            </fieldset>   
        </div>
