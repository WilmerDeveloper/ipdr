...
<fieldset>
    <?php echo $this->Form->create("Marketing", array("id" => "formularioMark", 'url' => array('controller' => 'Marketings', "action" => "edit", $this->data['Marketing']['id']))); ?>
    <?php echo $this->Form->hidden('Marketing.id'); ?>
    ...
    <?php echo $this->Form->hidden('Marketing.productive_baseline_id', array('label' => 'productive_baseline_id', 'class' => '')); ?>
