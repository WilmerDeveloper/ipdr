...
<div>
    <?php echo $this->Form->create("Formulation", array("id" => "frm", 'enctype' => 'multipart/form-data', 'type' => 'file', 'url' => array("action" => "add", $proyect_id))); ?>
    <table border="1">
        <tbody>
            <tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <?php echo $this->Form->hidden('Formulation.proyect_id', array('value' => $proyect_id)); ?>
                </td>
            </tr> 
            <tr>
                <td>Adjuntar resumen proyecto productivo</td>
                <td>
                    <?php echo $this->Form->file('Formulation.archivo_resumen', array('accept' => 'doc|docx', 'class' => 'required')); ?>
