...
<fieldset>
    <?php echo $this->Form->create("AgriculturalInfrastructure", array("id" => "formularioEstr", 'url' => array('controller' => 'AgriculturalInfrastructures', "action" => "add", $property_id))); ?>
    ...
    <?php echo $this->Form->hidden('AgriculturalInfrastructure.property_id', array('label' => 'property_id', 'value' => $property_id)); ?>
