...
<div id="actual1">
    <?php echo $this->Form->create("FloorUtility", array("id" => "formulario", "action" => "edit/" . $property_id)); ?>
    <fieldset><legend>Edición de Usos actuales de Suelo</legend>
        <?php echo $this->Form->hidden('FloorUtility.property_id', array('type' => 'text')); ?>
        <?php echo $this->Form->hidden('FloorUtility.id', array('type' => 'text')); ?>
