...
<fieldset>
    <?php echo $this->Form->create("AgriculturalSystem", array("id" => "formulario", 'url' => array('controller' => 'AgriculturalSystems', "action" => "edit", $this->data['AgriculturalSystem']['id']))); ?>
    ...
    <?php echo $this->Form->hidden('AgriculturalSystem.productive_baseline_id', array('type' => 'text')); ?>
    <?php echo $this->Form->hidden('AgriculturalSystem.id', array('type' => 'text')); ?>
