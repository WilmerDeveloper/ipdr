...
<fieldset>
    <?php echo $this->Form->create("Typology", array("id" => "tp", "url" => array("action" => "add", $plot_poll_id))); ?>
    ...
    <?php echo $this->Form->hidden('Typology.plot_poll_id', array('label' => 'plot_poll_id', 'value' => $plot_poll_id)); ?>
