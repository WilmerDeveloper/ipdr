...
<fieldset>
    <?php echo $this->Form->create("Property", array('id' => 'form', "action" => "edit_property/" . $this->data['Property']['id'])); ?>
    <fieldset>
        <table border="0">
            <tbody>
                <tr>
                    <td colspan="2">
                        ...
                        ?>
                                             ...
                                             <?php echo $this->Form->input('Property.call_id', array('label'=>'convocatoria', 'class' => 'required', 'empty' => '','options' => array('1'=>'2012','2'=>'2013','3'=>'2014'))); ?>
    ...
    <table width="100%" border="0"  CellSpacing=10  align="center" >
        <tbody>
            <tr>          
                <td><?php echo $this->Ajax->link($this->Html->image('regresar.gif', array('width' => '30', 'heigth' => '30', 'alt' => 'Regresar', 'title' => 'Regresar')), array('controller' => 'Properties', 'action' => 'property_index',$this->data['Property']['id']), array('update' => 'content', 'indicator' => 'loading', 'escape' => false)); ?></td>
            </tr>
        </tbody>
    </table>
</fieldset>