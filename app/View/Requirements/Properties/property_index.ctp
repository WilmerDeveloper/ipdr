...
<tbody>
    <?php foreach ($Properties as $Property): ?>
        <tr>
            ...
            <td>
                <?php  ;if( $Property['Property']['proyect_id']==0 OR $this->Session->read('cerrado')!=1) echo $this->Ajax->link('Editar', array('controller' => 'properties', 'action' => 'edit_property', $Property["Property"]["id"]), array('update' => 'content', 'indicator' => 'loading', 'class' => 'acciones', 'complete' => 'formularioAjax()')); ?>
                <br><br>
