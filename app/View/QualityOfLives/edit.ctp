...
<?php echo $this->Form->create("QualityOfLife", array('id' => 'formulario', "action" => "edit/" . $this->data['QualityOfLife']['id'])); ?>
<?php echo $this->Form->hidden('QualityOfLife.family_poll_id', array('value' => $this->data['QualityOfLife']['family_poll_id'])); ?>
<?php echo $this->Form->hidden('QualityOfLife.id'); ?>
<fieldset>
