...
<div id="consumo">
    <fieldset>
        <?php echo $this->Form->create("Consumption", array("id" => "formulario", "action" => "add/" . $productive_poll_id)); ?>
        <?php echo $this->Form->input('Consumption.productive_activity_id', array('label' => 'Producto', 'class' => 'required')); ?>
        <?php echo $this->Form->hidden('Consumption.productive_poll_id', array('value' => $productive_poll_id)); ?>
