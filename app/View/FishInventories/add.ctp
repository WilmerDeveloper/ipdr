...
<div>
    <fieldset>
        <?php echo $this->Form->create("FishInventory", array("id" => "formularioPez", 'url' => array('controller' => 'FishInventories', "action" => "add", $productive_baseline_id))); ?>
        ...
        <?php echo $this->Form->hidden('FishInventory.productive_baseline_id', array('label' => 'productive_baseline_id', 'value' => $productive_baseline_id)); ?>
