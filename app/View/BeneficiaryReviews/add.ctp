...
<fieldset>
    ...
    <?php echo $this->Form->create("BeneficiaryReview", array('enctype' => 'multipart/form-data', 'type' => 'file', 'url' => array("action" => "add", $this->data['Beneficiary']['id']))); ?>
    <?php
    echo $this->Form->hidden('BeneficiaryReview.user_id');
    echo $this->Form->hidden('BeneficiaryReview.fecha');
    echo $this->Form->hidden('Beneficiary.sincronizado', array('value' => 0));
    echo $this->Form->hidden('Beneficiary.id');
    ?>
    ...
    <table>
        <tbody>
            ...
            <?php endif; ?>
            <tr>
                <td colspan ="2"><?php echo $this->Form->input("BeneficiaryReview.concepto", array('label' => 'Justificación modificación', 'class' => 'txtarea', 'title' => 'Concepto')); ?></td>
            </tr>
        </tbody>
    </table>
