...
echo $this->Form->input("Item.orden", array('id' => 'usr'));
echo $this->Form->input("Item.nombre", array('id' => 'usr'));
echo $this->Form->input("Item.alias", array('id' => 'usr'));
...
echo $this->Ajax->submit('Submit', array('url' => array('controller' => 'Items', 'action' => 'add'), 'update' => 'content', ));
echo $this->Form->end();
?>
