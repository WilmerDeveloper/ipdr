...
<div id="acti">
    <fieldset >
        <?php echo $this->Form->create("Activity", array('id' => 'formulario', "action" => "add/" . $property_id)); ?>
        <legend>Adición de Actividades</legend>
        <?php echo $this->Form->hidden('Property.id') ?>   
        <?php echo $this->Form->hidden('Activity.property_id', array('value' => $property_id, 'type' => 'text')); ?>
