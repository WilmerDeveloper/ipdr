...
<?php echo $this->Form->create("PoultryInventory", array("id" => "formularioAvicola", 'url'=>array('controller'=>'PoultryInventories',  "action" => "edit",$this->data['PoultryInventory']['id']) )); ?>
<table border="1">
    <thead>
        <tr>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <?php echo $this->Form->hidden('PoultryInventory.productive_baseline_id'); ?>
                <?php echo $this->Form->hidden('PoultryInventory.id'); ?>
