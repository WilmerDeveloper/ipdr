<?php echo $this->Html->link('descargar reporte', array('controller' => 'Properties', 'action' => 'phase0_report'), array('update' => 'content', 'indicator' => 'loading', 'target' => '_blank', 'class' => 'acciones')); ?>
<br>
<br>
<?php
    ...
    <form style="clear: both" >
        <table border="0" cellspacing="0" cellpaddding="0" style="width: 200px;height: 20px; padding: 0px 0px 0px 0px">
            <tr>
                ...
                <td ><?php echo $this->Ajax->submit('Buscar', array('url' => array('controller' => 'Properties', 'action' => 'property_index'), 'update' => 'content', 'indicator' => 'loading')); ?></td>
            </tr>
        </table>
    </form>
</th>
...
<tbody>
    <?php foreach ($Properties as $Property): ?>
        <tr>
            ...
            <td>
                <?php echo $this->Ajax->link('Editar', array('controller' => 'properties', 'action' => 'edit_property', $Property["Property"]["id"]), array('update' => 'content', 'indicator' => 'loading', 'class' => 'acciones', 'complete' => 'formularioAjax()')); ?>
                <br><br>
                <?php echo $this->Ajax->link('Familias_beneficiarias', array('controller' => 'beneficiaries', 'action' => 'index', $Property["Property"]["id"]), array('update' => 'content', 'indicator' => 'loading', 'class' => 'acciones')); ?>
                <br><br>
                ...
                <br>
                <br>
                <?php echo $this->Ajax->link('Eliminar', array('controller' => 'properties', 'action' => 'delete', $Property["Property"]["id"]), array('update' => 'content', 'indicator' => 'loading', 'class' => 'acciones'), '¿Esta seguro de eliminar el predio?.Se borraran los datos de las familias asociadas'); ?>
                <br>
            </td>
            <td>
                <?php echo $this->Ajax->link('Adjuntar_Archivos', array('controller' => 'properties', 'action' => 'upload_files', $Property["Property"]["id"]), array('update' => 'content', 'indicator' => 'loading', 'class' => 'acciones')); ?>
                <br>
                <br>
                ...
                <br>
                <br>
                <?php echo $this->Ajax->link('Evaluar', array('controller' => 'properties', 'action' => 'phase0_evaluation', $Property["Property"]["id"]), array('update' => 'content', 'indicator' => 'loading', 'class' => 'acciones')); ?>
                <br>
            </td>
        </tr>
    <?php endforeach; ?>
