...
<table class="index">
    <thead>
        <tr>
            ...
            <th><?php if($this->Session->read('bloqueado')!=1) echo $this->Paginator->sort('Property.calificacion_fase0', 'Calificación fase 1'); ?></th>
...
<tbody>
    ...
    <tr>
        ...
        <td>
            ...
            <br>
                <?php
                    if($this->Session->read('bloqueado')!=1) echo $this->Ajax->link('Editar', array('controller' => 'PropertyReviews', 'action' => 'index', $Property["Property"]["id"]), array('update' => 'content', 'indicator' => 'loading', 'class' => 'acciones',));
                ?>
            <br>
            <br>
                <?php if($this->Session->read('bloqueado')!=1) echo $this->Ajax->link('Adjuntar Archivos', array('controller' => 'properties', 'action' => 'upload_files', $Property["Property"]["id"]), array('update' => 'content', 'indicator' => 'loading', 'class' => 'acciones')); ?>
            <br>
            <br>
