...
<div id="orga">
    <fieldset>
        <?php echo $this->Form->create("Organization", array('id' => 'formulario', "action" => "edit", $property_id)); ?>
        <legend>Edición de  Asociatividad y/o Organización</legend>
        <?php echo $this->Form->hidden('Organization.id', array()) ?>   
        <?php echo $this->Form->hidden('Organization.property_id', array('type' => 'text')); ?>
