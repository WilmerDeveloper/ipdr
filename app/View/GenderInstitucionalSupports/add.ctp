...
<?php echo $this->Form->create("GenderInstitucionalSupport", array('id' => 'formulario', "action" => "add/" . $poll_id)); ?>
<?php echo $this->Form->hidden('GenderInstitucionalSupport.family_poll_id', array('value' => $poll_id)); ?>
<fieldset>
