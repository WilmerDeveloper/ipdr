...
<div id="lineas">
    <fieldset>
        <?php echo $this->Form->create("MarketingLine", array("id" => "formulario", "action" => "add/" . $productive_poll_id)); ?>
        <?php echo $this->Form->hidden('MarketingLine.productive_poll_id', array('value' => $productive_poll_id, 'type' => 'text')); ?>
        ...
        <?php echo $this->Form->input('MarketingLine.unidad', array('label' => '5.13.7 Unidad', 'class' => '','options'=>array('empty'=>'', 'Toneladas'=>'Toneladas','Kilogramos'=>'Kilogramos','Bultos'=>'Bultos','Litros'=>'Litros','Por producto'=>'Por producto'))); ?>
