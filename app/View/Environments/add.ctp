...
<div id="ambiente">
    <fieldset>
        <?php echo $this->Form->create("Environment", array('id' => 'formulario', "action" => "add/" . $property_id)); ?>
        <?php echo $this->Form->hidden('Environment.id') ?>   
        <?php echo $this->Form->hidden('Environment.property_id', array('value' => $property_id, 'type' => 'text')); ?>
