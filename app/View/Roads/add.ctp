        ...
        jQuery("#formulario").validate({
            submitHandler: function(form) {
                jQuery(form).ajaxSubmit({
                    target: "#roads",beforeSubmit: function() {
                        $(".submit_button").hide();
...
<div id="roads">
    <fieldset>
        <?php echo $this->Form->create("Road", array('id' => 'formulario', "action" => "add/" . $property_id)); ?>
        <legend>Adición de Vías de acceso</legend>
        <?php echo $this->Form->hidden('Road.property_id', array('value' => $property_id, 'type' => 'text')); ?>
