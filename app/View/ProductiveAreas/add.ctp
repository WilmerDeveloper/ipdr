...
<div id="area">
    <fieldset>
        <?php echo $this->Form->create("ProductiveArea", array('id' => 'formulario', "action" => "add/" . $productive_poll_id)); ?>
        ...
        <?php echo $this->Form->input('ProductiveArea.area', array('label' => '5.3.6 Área Total en el cultivo o explotación pecuaria ', 'class' => 'required')); ?>
        ...
        <?php echo $this->Form->input('ProductiveArea.orden', array('label' => 'orden', 'class' => '')); ?>
        <?php echo $this->Form->input('ProductiveArea.cosechas', array('label' => 'cosechas', 'class' => '')); ?>
        ...
        <?php echo $this->Form->input('ProductiveArea.analisis_suelos', array('label' => '5.4.9 ¿Tiene análisis de Suelos?', 'class' => '', 'empty' => '', 'options' => array('Si' => 'Si', 'No' => 'No'))); ?>
        <?php echo $this->Form->input('ProductiveArea.fecha_analisis', array('label' => 'Fecha análisis', 'class' => 'calendario','type'=>'text')); ?>
        <?php echo $this->Form->hidden('ProductiveArea.productive_poll_id', array('value' => $productive_poll_id, 'class' => 'required', 'type' => 'text')); ?>
