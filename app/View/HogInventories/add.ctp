...
<?php echo $this->Form->create("HogInventory", array("id" => "formulario", 'url' => array('controller' => 'HogInventories', "action" => "add", $productive_baseline_id))); ?>
...
<div style="border: solid 1px; border-color: #003399">
    <fieldset>Aspectos sanitarios:<br>
        ...
        <?php echo $this->Form->hidden('HogInventory.productive_baseline_id', array('label' => 'productive_baseline_id', 'value' => $productive_baseline_id)); ?>
    </fieldset>
</div>
