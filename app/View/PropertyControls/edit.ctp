...
<div id="control">
    <fieldset>
        <?php echo $this->Form->create("PropertyControl", array("id" => "formulario", "action" => "edit/" . $this->data['PropertyControl']['id'])); ?>
        <?php echo $this->Form->hidden('PropertyControl.id'); ?>
        <?php echo $this->Form->hidden('PropertyControl.property_id'); ?>
