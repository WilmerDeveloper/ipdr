...
<div id="devices">
    <?php echo $this->Form->create("Device", array("id" => "formulario", "action" => "edit/" . $this->data['Device']['id'])); ?>
    ...
    <?php echo $this->Form->hidden('Device.home_id'); ?>
    <?php echo $this->Form->input('Device.id'); ?>
