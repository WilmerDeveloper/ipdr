...
<div id="homes">
    <?php echo $this->Form->create("PublicService", array("id" => "formulario", "action" => "add/".$home_id)); ?>
    ...
    <?php echo $this->Form->hidden('PublicService.home_id', array('type'=>'text', 'value' => $home_id)); ?>
