...
<div id="livestocks">
    <?php echo $this->Form->create("LiveStock", array("id" => "formulario", "action" => "add/" . $home_id)); ?>
    ...
    <?php echo $this->Form->input('LiveStock.cantidad', array('label' => 'Cantidad', 'class' => 'required')); ?>
    <?php echo $this->Form->hidden('LiveStock.home_id', array('value' => $home_id)); ?>
