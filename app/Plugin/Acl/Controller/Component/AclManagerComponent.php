...
//		}
	...
	public function create_acos()
	{
		...
		if (empty($root))
		{
		     ...
		     */
		    echo "ENTROO1";
			$aco->create(array('parent_id' => null, 'model' => null, 'alias' => 'controllers','foreign_key'=>0));
			$root              = $aco->save();
			$root['Aco']['id'] = $aco->id;
	        ...
	        if($controller_name !== 'App')
	        {
    	        ...
    	        if(!empty($plugin_name))
    	        {
    	            ...
    	            if(empty($pluginNode))
    	            {
    	                ...
    	                $aco->create(array('parent_id' => $root['Aco']['id'], 'model' => null, 'alias' => $plugin_name,'foreign_key'=>0));
    					$pluginNode              = $aco->save();
                ...
                if(empty($controllerNode))
                {
                    ...
                    if(isset($pluginNode))
                    {
                        ...
                        $aco->create(array('parent_id' => $plugin_node_aco_id, 'model' => null, 'alias' => $controller_name,'foreign_key'=>0));
                    ...
                    else
                    {
                        ...
                        $aco->create(array('parent_id' => $root['Aco']['id'], 'model' => null, 'alias' => $controller_name,'foreign_key'=>0));
    					$controllerNode              = $aco->save();
    					$controllerNode['Aco']['id'] = $aco->id;
        	    ...
        	    foreach($actions as $action)
        	    {
        	        ...
        	        if(empty($actionNode))
        	        {
        	            ...
        	            $aco->create(array('parent_id' => $controllerNode['Aco']['id'], 'model' => null, 'alias' => $action,'foreign_key'=>0));
    					$methodNode = $aco->save();
